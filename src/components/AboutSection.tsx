        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          ease: "easeOut"
            ...
            <div className="relative w-72 md:w-80 lg:w-96">
              ...
              <motion.div className="absolute -inset-4 bg-gradient-to-br from-primary/30 via-primary/10 to-transparent rounded-3xl blur-xl" animate={{
              opacity: [0.5, 0.8, 0.5],
              scale: [1, 1.02, 1]
            }} transition={{
              duration: 4,
              ...
              <div className="profile-container aspect-square">
                <img src={hugoProfile} alt="Hugo Megardon - Freelance Web Designer" className="w-full h-full object-cover object-center" />
