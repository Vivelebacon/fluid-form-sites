...
const projects = [{
  ...
  description: "Corporate website showcasing digital and technical solutions with a modern design. Built with performance and user experience as top priorities.",
...
const PortfolioSection = () => {
  ...
  return <section id="portfolio" className="py-32 relative overflow-hidden">
      {/* Background glow */}
              ...
              <div className="relative glass-card rounded-2xl overflow-hidden portfolio-shine hover-lift card-shine">
                ...
                <div className="p-8 md:p-12">
                  ...
                  <div className="flex items-center gap-4 mb-6">
                    <img src={megaAiLogo} alt="Mega AI Solutions Logo" className="h-10 w-auto rounded-lg opacity-90" />
                    {project.featured && <motion.div initial={{
                  opacity: 0,
                  scale: 0.8
                }} animate={isInView ? {
                  opacity: 1,
                  ...
                  <div className="flex flex-wrap gap-3 mb-8">
                    {project.tags.map(tag => <span key={tag} className="px-4 py-2 rounded-full text-sm font-medium bg-muted text-muted-foreground">
                        {tag}
                      </span>)}
                  </div>
                  ...
                  <a href={project.link} target="_blank" rel="noopener noreferrer" className="inline-block">
                    <Button size="lg" className="group/btn relative overflow-hidden bg-primary text-primary-foreground hover:bg-primary/90 px-8 py-6 text-lg font-medium rounded-full transition-all duration-300 hover:shadow-[0_0_30px_hsl(185,55%,45%,0.4)]">
